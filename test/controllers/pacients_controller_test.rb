...
class PacientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pacient" do
    assert_difference('Pacient.count') do
      post pacients_url, params: { pacient: { age: @pacient.age, last_name: @pacient.last_name, name: @pacient.name } }
    end
  ...
  test "should update pacient" do
    patch pacient_url(@pacient), params: { pacient: { age: @pacient.age, last_name: @pacient.last_name, name: @pacient.name } }
